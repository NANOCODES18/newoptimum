...
<<<<<<< HEAD
    ...
    <div class="header-text head-text">
        <div class="heading-text">
            <p data-aos="fade-right"><span>Optimising</span> your <br> <span> finance</span> for <br> <span>profits</span>
            </p><button>GET STARTED</button>
        </div>
        <div class="float">
            <img src="user/assets/images/rocket.png" class="floating" alt="" loading="lazy">
=======
...
>>>>>>> 62102d3d6d96ccd0e9a36cbbb042703765686f80
        </div>
    </div>

    <div class="card-father parent">
        <div class="btc-marque" style="background-color: transparent;">
            <iframe loading="lazy" src="https://bit2me.com/widget/crypto-carousel/v1" style="display:block;width:100%;height:40px;"
    ...
    <div class="card-section">
        ...
        <div class="card" data-aos="fade-up-left">
            <img src="user/assets/images/investment-model-svgrepo-com 1.svg" alt="" />
            <div class="card-text">
                <h3>Binary Option</h3>
                <p>
                    A binary option is a financial exotic option in which the payoff is either some fixed monetary amount or
        ...
        <div class="card" data-aos="zoom-in">
            <img src="user/assets/images/increasing-stocks-graphic-of-bars-svgrepo-com 1.svg" alt="" />
            <div class="card-text">
                <h3>Stocks & ETF</h3>
                <p>
                    A stock or share is a financial instrument that  represents a proportionate claim on a company
                    or corporation, its assets and
                    and earnings...An exchange-traded fund (E.T.F)is a type of investment fund and exchange-traded product,
                    i.e. they are traded on stock exchanges, We offer both services free to the public for them to make
                    profits with us
                </p>
                <button>Read more</button>
            </div>
        ...
        <div class="card" data-aos="fade-up-right">
            <img src="user/assets/images/coin-stack-svgrepo-com (1) 1.svg" alt="" />
            <div class="card-text">
                <h3>Crypto Currency</h3>
                <p>
                    {{ $compd ? $compd->companyname : 'company name' }} now offers all traders the opportunity to trade a wide
                    range of the top ranked digital coins 24/7*.
                    Today cryptocurrencies have become known to most people, Surprising as it might be, anyone can invest in
                    the crypto market to make a profit </p>
                <button>Read more</button>
            </div>
        </div>
    </div>
    ...
    <div class="trade-option">
        <div class="trading">
            <div class="trading-content"data-aos="fade-up-right">
                <img src="user/assets/images/Group (1).svg" alt="time" loading="lazy">
                <div class="text">
                    <h3>OPEN AN ACCOUNT</h3>
                    <p>To open an account, simply click on the "Register" button on the main page. The next page is the
                        registration form that you need to fill out. This shouldn’t take more than a few minutes. Once
                        you’ve done that, you’ll receive an email from us, and you’re done.
                    </p>
                </div>
            </div>
            <div class="trading-content" data-aos="fade-up-right">
                ...
                <div class="text">
                    <h3>LOGIN TO MEMBER'S AREA</h3>
                    <p>Once you’ve opened an account, the next thing would be to familiarize yourself with how different
                        sections of your account works. To start, go to the login page and enter your registration username
                        and chosen password.
                    </p>
                </div>
            </div>
            <div class="trading-content" data-aos="fade-up-right">
                ...
                <div class="text">
                    <h3>MAKE YOUR FIRST DEPOSIT & WATCH YOUR CAPITAL GROW</h3>
                    <p>To start earning, you need to make a deposit. You can do this from the deposit section of your
                        account. The minimum deposit amount is different for different plans, and you are allowed to make as
                        many deposits as you want. After you have made a deposit, select an investment plan and invest in
                        then watch your investment grow.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="about-header">
        ...
        <div class="about">
            ...
            <div class="about-text">
                <h1>{{ $compd ? $compd->companyname : 'company name' }}</h1>
                <P>{{ $compd ? $compd->companyname : 'company name' }} Company is a distinctive investment company offering our
                    investors access to high-growth investment opportunities in Bitcoin markets and other services. We
                    implement best practices of trading & mining of Bitcoins through our operations, while offering
                    flexibility in our investment plans. Our company benefits from an extensive network of global clients.
                </P>
                <h3><span>OUR MISSION</span>|OUR ADVANTAGES| OUR GUARANTY</h3>
                <P>Our aim is to utilize our expertise & knowledge which will benefit our clients and the users of our
                    services.</P>
        ...
        <div class="asset-management">
            <div class="asset-text">
                ...
                <p>As high-conviction investors, we refuse to follow the herd. Instead, we focus on stocks that are out of
            ...
            <div class="asset-content">
                <div class="asset-files">
                    <i class="fa fa-money" aria-hidden="true"></i>
                    <h2>Asset Managment</h2>
                    <p>we are trusted adivisor to our clients , assisting them in developing and accessing alternatives to
                        meet our strategic developments.</p>

                    <div class="over-lay">
                        <div class="text">
                            <i class="fa fa-money" aria-hidden="true"></i>
                            <h2>Asset Managment</h2>
                            <p>we are trusted adivisor to our clients , assisting them in developing and accessing
                                alternatives to meet our strategic developments.</p>
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="user/http://www.w3.org/2000/svg">
                ...
                <div class="asset-files files2">
                    ...
                    <div class="over-lay">
                        <div class="text">
                            <i class="fa fa-money" aria-hidden="true"></i>
                            <h2>Wealth Management</h2>
                            <p>Advising wealthy families sometimes overall generations is a complex task of responsibiliy
                            </p>
        ...
        <div class="video-section">
            <div class="video-frame">
                <iframe width="100%" loading="lazy" height="250px" src="https://www.youtube.com/embed/Gc2en3nHxA4"
                    title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen>
                </iframe>
            ...
            <div class="video-sec">
                <div style="width:380px;">
                    <crypto-converter-widget live shadow symbol fiat="united-states-dollar" crypto="bitcoin"
                        amount="1" border-radius="0.60rem" background-color="#383a59" decimal-places="2"><a
                            href="https://cr.today/" rel="noopener">Converter Widget</a></crypto-converter-widget>
    ...
    <div class="last-empty emmy"></div>
        ...
        <div class="stocky" style="display: flex; justify-content:center; padding:20px;">
            <div class="stock-flex">
                <div class="buy-crypto" data-aos="fade-up-left">
                    <h3>Cryptocurrencies Trading</h3>
                    <p>{{ $compd ? $compd->companyname : 'company name' }} now offers all traders the opportunity to trade a
                        wide range of the top ranked digital coins 24/7*.</p>
                    <button><a href="user/login and signup/signup.html">Invest in stocks</a></button>
                    <script defer src="https://www.livecoinwatch.com/static/lcw-widget.js"></script>
                    <div class="livecoinwatch-widget-6" lcw-coin="BTC" lcw-base="USD" lcw-period="d"
                        lcw-color-tx="#000000" lcw-color-bg="#ffffff" lcw-border-w="0"></div>
                    <script defer src="https://www.livecoinwatch.com/static/lcw-widget.js"></script>
                    <div class="livecoinwatch-widget-6" lcw-coin="SOL" lcw-base="USD" lcw-period="d"
                        lcw-color-tx="#000000" lcw-color-bg="#ffffff" lcw-border-w="0"></div>
                    <script defer src="https://www.livecoinwatch.com/static/lcw-widget.js"></script>
                    <div class="livecoinwatch-widget-6" lcw-coin="ETH" lcw-base="USD" lcw-period="d"
                        lcw-color-tx="#000000" lcw-color-bg="#ffffff" lcw-border-w="0"></div>
                </div>
        ...
        <div class="trade-invest">
            <div class="trade-invest-text">
                <h2>
                    <b>Trade and invest</b> in top stocks and ETFs. Trade currency pairs, Indices and Commodities via CFDs.
            ...
            <div class="slider-container swiper mySwiper">
                <div class="swiper-wrapper slider-content">
                    <div class="swiper-slide slider-card">
                        <div class="card-content">
                            <div class="image">
                                <img src="user/images/profile1.jpg" alt=""loading="lazy">
                            </div>
                            <div class="rating">
                                <span class="name">Willie E. Maynard</span>
                                <span class="testimony">Then plan is to not only protect the value of your assets but to
                                    increase them. I am glad with having professional traders that manage money in high risk
                                    markets manage my portfolio here and the profit have been over whelming. </span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide slider-card">
                        <div class="card-content">
                            <div class="image">
                                <img src="user/images/profile2.jpg" alt=""loading="lazy">
                            </div>
                            <div class="rating">
                                <span class="name">Francesca Boyle</span>
                                <span class="testimony">I wish to thank you for this divine help because after two weeks we
                                    are out of debt trading with your strategy and also the amount you made ($135,776)
                                    profit totaling $220,338 in equity from the $84,562 we gave to you made us pay our
                                    clients </span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide slider-card">
                        <div class="card-content">
                            <div class="image">
                                <img src="user/images/profile3.jpg" alt=""loading="lazy">
                            </div>
                            <div class="rating">
                                <span class="name">Ryan J. Roseberry</span>
                                <span class="testimony">INVEST because only one month the account of $5000 has grown to
                                    $16,500 profit and I've made over 50% within one month which has been equally shared, It
                                    only takes a few seconds to initiate your withdrawals and have your earnings paid to
                                    you. Most importantly all withdrawals are instant.</span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide slider-card">
                        <div class="card-content">
                            <div class="image">
                                <img src="user/images/profile4.jpg" alt=""loading="lazy">
                            </div>
                            <div class="rating">
                                <span class="name">Hamish Wienholt</span>
                                <span class="testimony">Your portfolio management is well planned and structured which made
                                    me know that its not a PONSI scheme. After starting investment with you people I now see
                                    reasons to know that there are people making it BIG in TRADING .</span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide slider-card">
                        <div class="card-content">
                            <div class="image">
                                <img src="user/images/profile7.jpg" alt=""loading="lazy">
                            </div>
                            <div class="rating">
                                <span class="name">Michelle M. Coleman</span>
                                <span class="testimony">Wow this is wonderfully, it works like magic. More grace to your
                                    elbow {{ $compd ? $compd->companyname : 'company name' }} Platform. You guys are just
                                    sweet, thanks so so much for good and excellent service delivery</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide slider-card">
                        <div class="card-content">
                            <div class="image">
                                <img src="user/images/profile6.jpg" alt="" loading="lazy">
                            </div>
                            <div class="rating">
                                <span class="name">Mark K. Cool</span>
                                <span class="testimony">I have been into many trading close to 4years now. Many strategy I
                                    have tried but all failed. I got frustrated and was almost calling it quit. Little did I
                                    know that a {{ $compd ? $compd->companyname : 'company name' }} existed....Thanks i
                                    stumbled on there facebook advert</span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide slider-card">
                        <div class="card-content">
                            <div class="image">
                                <img src="user/images/profile5.jpg" alt=""loading="lazy">
                            </div>
                            <div class="rating">
                                <br>
                                <span class="name">Brian S. Delgado</span>
                                <span class="testimony">Good company to deal with , excellent customer service, fast
                                    payment. It takes a lot to trust an investment firm in this climate but i am very happy
                                    with there services so far.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide slider-card">
                        <div class="card-content">
                            <div class="image">
                                <img src="user/images/profile8.jpg" alt="" loading="lazy">
                            </div>
                            <div class="rating">

                                <span class="name">Suzanne W. Nguyen</span>
                                <span class="testimony">Since investing with
                                    {{ $compd ? $compd->companyname : 'company name' }}, we have seen gains in our portfolio in
                                    a short space of time which is a reassuring indicator. Lastly I just to say many thanks
                                    for a very positive meeting yesterday. </span>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide slider-card">
                        <div class="card-content">
                            <div class="image">
                                <img src="user/images/profile9.jpg" alt="" loading="lazy">
                            </div>
                            <div class="rating">

                                <span class="name">Cheryl S. Hammack</span>
                                <span class="testimony"> This approaches fully integrates life plans and the financial
                                    plans and makes very good sense. {{ $compd ? $compd->companyname : 'company name' }}
                                    investment is very client centred and professional and we would happily recommend their
                                    services to others.</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    @foreach ($investmentplans as $plan)
                        <div class="card-pricing">
                            ...
                            <div class="card-content">
                                <ul>
                                    <li><i class="fa fa-dollar"></i><Span>${{ $plan->maximum }}</Span> -maximum</li>
                                    <li><i class="fa fa-check-circle"></i>{{ $plan->percentage * $plan->noofrepeat }}%
                                        monthly Return</li>
                                    <li><i class="fa fa-check-circle"></i> 4 times</li>
                                    <li><i class="fa fa-check-circle"></i>{{ $plan->percentage }}% ROI Each time</li>
                                    <li></i><i class="fa fa-dollar"></i>1,250+ Total Return</li>
